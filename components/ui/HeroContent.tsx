...
const HeroContent = () => {
  return (
    <div
      className="w-full lg:w-1/2 h-auto lg:h-screen flex items-center relative z-10 bg-[var(--color-red)] px-6 py-12 lg:px-16 lg:py-0"
      role="region"
    ...
    >
      ...
      <div className="relative max-w-xl flex flex-col items-start animate-in fade-in slide-in-from-bottom-10 duration-1000">
        <div className="relative mb-6 lg:mb-8">
          <h1
            id="hero-heading"
            className="font-serif text-[15vw] md:text-8xl lg:text-[7rem] xl:text-[8rem] leading-[0.9] text-[var(--color-white)] tracking-tighter relative z-10"
          >
              The Cozy &
          </h1>
          <h2
        ...
        <div className="mt-8 md:mt-12 max-w-lg border-l border-[var(--border)] pl-6">
          <p className="text-muted-foreground text-base md:text-lg font-light leading-relaxed">
              From our family table to yours—a cozy space to gather, eat, laugh, and roll the dice.
              Welcome to your new favorite hideout.
          </p>
        </div>
