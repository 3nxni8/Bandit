                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-0">
                    ...
                    <div className="w-full order-1 lg:order-2 flex">
                        <div className="flex flex-col justify-center px-6 md:px-16 lg:px-24 py-12">
                            ...
                            {/* Decorative Icon */}
                            <div className="mb-8">
                                <Flower2 strokeWidth={1} className="w-12 h-12 text-foreground/80" />
                            </div>
                            ...
                            <div className="mb-12 space-y-4 border-l-2 border-[var(--color-red)] pl-6">
                                ...
                                <div className="grid grid-cols-[80px_1fr] gap-y-2 font-sans text-sm tracking-wide">
                                    <span className="font-semibold text-foreground">Mon – Thu:</span>
                                    <span className="text-muted-foreground">10:00 am — 01:00 am</span>

                                    <span className="font-semibold text-foreground">Fri – Sun:</span>
                                    <span className="text-muted-foreground">10:00 am — 01:00 am</span>
                                </div>
                            </div>
