...
export const Marquee: React.FC = () => {
    return (
        <div className="w-full bg-[#FAF9F6] py-6 overflow-hidden relative" role="region" aria-label="Featured dishes">
                ...
                <div className="flex whitespace-nowrap animate-marquee w-max">
                    ...
                    {[...marqueeItems, ...marqueeItems].map((item, idx) => (
                        <div key={idx} className="flex items-center mx-8">
                            <span className="text-3xl md:text-5xl font-serif text-[#ef4444] mr-6">
                                {item.text}
                            </span>
